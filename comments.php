...
<div id="comments" class="comments-area widget widget-job_listing">
	...
	<?php if( ($msw->get_user_role() !== 'customer') ) : ?>
		<p class="no-comments">
			<?php _e( 'Comments are allowed for customers only.', 'listify' ); ?>
		</p>
	<?php return; endif; ?>

	<?php if( !$msw->customerReceivedCashback()  ) : ?>
		<p class="no-comments">
			<?php _e( 'You must receive a cashback from this business to review.', 'listify' ); ?>
		</p>
	<?php return; endif; ?>
